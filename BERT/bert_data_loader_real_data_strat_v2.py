...
size_train=2000
size_testvalid=300 #valid_df.shape[0]
train_dataset = train_df[0:size_train].reset_index(drop=True)
valid_dataset = valid_df[0:size_testvalid].reset_index(drop=True)
test_dataset = test_df[0:size_testvalid].reset_index(drop=True)
...
print(f"\nUsing model with a macro f1 score of {best_f1_score} for the dev set.")
